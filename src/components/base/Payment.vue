<template>
  <div>
    ...
    <button type="button" class="btn btn-danger btn-lg w-100" data-toggle="modal" :data-target="'#payment' + campaign_token">ОПЛАТИТЬ ОНЛАЙН</button>
              ...
              <div class="col">
                  <form action="/grform/payment" method="get" id="grForm">
                      ...
                      <div class="row justify-content-center">
                          <div class="col-lg-8">
                            <div class="form-group form-group-lg">
                              <input type="phone" class="form-control" name="phone" placeholder="Телефон" v-model="modal.phone">
                            </div>
                          </div>
                      </div>
