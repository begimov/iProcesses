  ...
  <div>
    <div class="jumbotron jumbotron-fluid text-white">
      <div class="container">
        ...
        <p class="lead mb-2"><span class="badge badge-success">Мастер-проект стартовал!</span></p>
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <p class="card-text">
                          ...
                          <ol>
                            <li>Примерный регламент работы команды</li>
                            <li>Типовой план проекта</li>
                            <li>Лист оценки рисков проекта</li>
                            <li>Инструкция по проведению оценки системы управления процессами</li>
                            <li>Опросный лист оценки системы управления процессами</li>
                            <li>Методическое руководство по анализу проблем</li>
                            <li>Инструкция по проведению мозгового штурма</li>
                            <li>Инструкция по проведению голосования</li>
                            <li>Шаблон для ранжирование предложений</li>
                            <li>Рабочая тетрадь 1</li>
                          </ol>
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <p class="card-text">
                          <strong>Шаблоны:</strong>
                          <ol>
                            <li>Структура документа «Стратегия компании»</li>
                            <li>Пример стратегии</li>
                            <li>Инструкция по проведению мозгового штурма</li>
                            <li>Инструкция по проведению голосования</li>
                            <li>Шаблон для ранжирование предложений</li>
                            <li>Перечень ошибок при разработке стратегии</li>
                            <li>Рабочая тетрадь 2</li>
                          </ol>
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col">
                        ...
                        <p class="card-text">
                          <strong>Шаблоны:</strong>
                          <ol>
                            <li>Методика определения процессов верхнего уровня</li>
                            <li>Пример карты основных процессов компании</li>
                            <li>Пример организационной концепции</li>
                            <li>Пример концептуального описания процесса стратегического управления</li>
                            <li>Пример концептуального описания процесса годового планирования</li>
                            <li>Пример концептуального описания процесса разработки новых продуктов</li>
                            <li>Комментарии к заключительной части мастер-класса</li>
                            <li>Рабочая тетрадь 3</li>
                          </ol>
                        </p>
                      </div>
                    </div>
